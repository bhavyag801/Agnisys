          ...
          <div className="row">
            ...
            <div className="col-4">
              ...
              <div className="d-flex card__action__btn flex-column gap-2">
                ...
                <button onClick={() => setStartDateShow(true)}>
                  <span className="icon__sm">
                    <Calendar />
                  </span>
                  Start Date
                ...
                {startDateShow && (
                  <div>
                    ...
                    />
                    <button onClick={() => setStartDateShow(false)}>Save</button>
                  </div>
                )}
                <button onClick={() => setEndDateShow(true)}>
                  <span className="icon__sm">
                    <Calendar />
                  </span>
                  End Date
                ...
                {endDateShow && (
                  <div>
                    ...
                    />
                    <button onClick={() => setEndDateShow(false)}>Save</button>
                  </div>
                )}
